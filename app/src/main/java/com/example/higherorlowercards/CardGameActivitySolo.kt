...
class CardGameActivitySolo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun incorrectWindow(hiLow: String, value: String){
            ...
            builder.setMessage("Следующая карта на самом деле была $hiLow, вы потеряли $$value.00.")
        ...
        fun correctWindow(hiLow: String, value: String){
            ...
            builder.setMessage("Следующей картой была $hiLow, вы заработали $$value.00.")
        ...
        textCurrentBalance.text = "Баланс: $" +("%.2f".format(getBankBalance().toDouble()))
        ...
        fun checkUserBalance() {
            if (getBankBalance().toDouble() == 0.0) {
                ...
                val builder = AlertDialog.Builder(this)
                builder.setTitle("Закончились средства!")
                builder.setMessage("У вас закончились средства, посетите банк, чтобы получить больше денег.")
                builder.show()
        ...
        buttonLower.setOnClickListener {
            ...
            if (CardCreator.isSmaller(secondCard, firstCard)){
                //Correct
                correctWindow("меньше", betFinal.toString())
                ...
                //Incorrect
                incorrectWindow("больше", betFinal.toString())
                var BANK_BALANCE = getBankBalance().toDouble()
                BANK_BALANCE -= betFinal
                setBankBalance(BANK_BALANCE.toString())
                checkUserBalance()
        ...
        buttonHigher.setOnClickListener{
            ...
            if (CardCreator.isLarger(secondCard, firstCard)){
                //Correct
                correctWindow("больше", betFinal.toString())
                var BANK_BALANCE = getBankBalance().toDouble()
                BANK_BALANCE += betFinal
                setBankBalance(BANK_BALANCE.toString())
            }
                ...
                //Incorrect
                incorrectWindow("меньше", betFinal.toString())
                var BANK_BALANCE = getBankBalance().toDouble()
                BANK_BALANCE -= betFinal
                setBankBalance(BANK_BALANCE.toString())
                checkUserBalance()
        ...
        seekBarBet.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener{
            ...
            override fun onProgressChanged(seekBar: SeekBar, i: Int, b : Boolean){
                ...
                textBetVal.text = "Сумма ставки: $" +betFinal +".00"
            ...
            override fun onStopTrackingTouch(seekBar: SeekBar) {
                Toast.makeText(this@CardGameActivitySolo, "Вы поставили $" +betFinal, Toast.LENGTH_SHORT).show()
            }
        })
