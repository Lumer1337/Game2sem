...
class BankActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun setBankBalance(amount: String){
            ...
            textBalance.text = "Баланс: $" +("%.2f".format(amount.toDouble()))
        }
        ...
        textBalance.text = "Баланс: $" +("%.2f".format(getBankBalance().toDouble()))
        ...
        buttonClaim.setOnClickListener{
            ...
            if (formatted.toString()==getLastUsed()) {
                ...
                builder.setTitle("Вы успешно забрали деньги")
                builder.setMessage("Вы уже забрали сегодня 100$. Возвращайтесь завтра!")
                builder.show()
            }
            else {
                BANK_BALANCE += 100.00
                ...
                val builder = AlertDialog.Builder(this)
                builder.setTitle("Вы успешно забрали деньги")
                builder.setMessage("Вот ваши 100$.Возвращайтесь завтра!")
                builder.show()
